/**
 * File:        apps/backend/src/core/application/use-cases/automation/update-automation/update-automation.dto.ts
 * Module:      Automation Use Cases
 * Purpose:     Data transfer object for UpdateAutomation use case
